...
class User(BaseModel):
    ...
    hear_url = CharField(max_length=200, null=True, verbose_name="头像")
    birthday = DateField(null=True, verbose_name="生日")
    address = CharField(max_length=200, null=True, verbose_name="地址")
    desc = TextField(null=True, verbose_name="个人简介")
    # salt = CharField(max_length=200, null=True, verbose_name="盐")
...
if __name__ == "__main__":
    ...
    # for i in range(10):
    #     user = User()
    #     user.nick_name = f"jeff{1}"
    #     user.mobile = f"1875652495{i}"
